...
const translations = {
  es: {
    ...
    "about-text": "Soy un programador y diseñador de videojuegos de 25 años, vivo en Sanlúcar de Barrameda, Cádiz. Apasionado de los videojuegos desde joven, decidí convertir esa pasión en una carrera profesional formándome en programación con un enfoque claro en el desarrollo de videojuegos. Actualmente trabajo como freelancer, combinando creatividad y código para dar vida a nuevas historias. Me encanta aprender, experimentar con nuevas tecnologías y trabajar en proyectos que inspiren.",
  ...
  en: {
    ...
    "about-text": "I'm a 25-year-old video game programmer and designer living in Sanlúcar de Barrameda, Cádiz. Passionate about games since I was young, I decided to turn that passion into a career by training in programming with a clear focus on game development. Currently, I work as a freelancer, combining creativity and code to bring new stories to life. I love learning, experimenting with new technologies, and working on inspiring projects.",
    "title-experience1": "FREELANCER",
